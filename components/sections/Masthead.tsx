...
export default function Masthead() {
  ...
  return (
    <header style={{ borderBottom: '3px solid var(--fg)' }}>
      ...
      {/* Lead 3-column grid */}
      <div style={{ display: 'grid', gridTemplateColumns: '3fr 5fr 3fr', columnGap: 0, borderBottom: '2px solid var(--fg)' }}>
        {/* Left */}
        ...
        <div style={{ padding: '24px 28px', display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Portrait */}
          <div style={{ marginTop: '24px', flex: 1, minHeight: '200px', maxHeight: '300px', border: '1px solid rgba(14,14,12,0.2)', overflow: 'hidden', position: 'relative' }}>
