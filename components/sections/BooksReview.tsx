...
const booksData: BookData[] = [
  { id: 1,  title: 'Sapiens',                author: 'Yuval Noah Harari', coverImage: '/book-covers/sapiens.webp',                         spineColor: '#fefcfb', textColor: '#1a1a2e', status: 'currently-reading', rating: 5, overview: 'A brief history of humankind, exploring how Homo sapiens came to dominate the world through cognitive, agricultural, and scientific revolutions.' },
  { id: 2,  title: 'Atomic Habits',          author: 'James Clear',       coverImage: '/book-covers/atomic-habits.webp',                   spineColor: '#fefcfb', textColor: '#1a1a1a',                             rating: 5, overview: 'Tiny changes, remarkable results. A proven framework for improving every day through the compound effect of small habits.' },
  { id: 3,  title: 'The Alchemist',          author: 'Paulo Coelho',      coverImage: '/book-covers/the-alchemist.webp',                   spineColor: '#f17623', textColor: '#ffffff',                             rating: 4, overview: 'A magical fable about following your dreams. Santiago, a shepherd boy, journeys to find treasure and discovers the true meaning of life.' },
  { id: 4,  title: '48 Laws of Power',       author: 'Robert Greene',     coverImage: '/book-covers/48-laws-of-popwer.webp',               spineColor: '#e33d31', textColor: '#ffffff', status: 'currently-reading', rating: 4, overview: 'A masterful guide to understanding power dynamics through historical examples and timeless strategies for gaining influence.' },
  { id: 5,  title: 'Psychology of Money',    author: 'Morgan Housel',     coverImage: '/book-covers/the-psychology-of-money.webp',         spineColor: '#fefcfb', textColor: '#1a1a1a',                             rating: 5, overview: 'Timeless lessons on wealth, greed, and happiness. How behavior matters more than knowledge in financial success.' },
  { id: 6,  title: '21 Lessons',             author: 'Yuval Noah Harari', coverImage: '/book-covers/21-lessons-for-21st-century.webp',     spineColor: '#b8b6c1', textColor: '#1a1a1a', status: 'will-read',        rating: 4, overview: 'Explores the most pressing issues of our present: technology, truth, justice, and how to navigate an uncertain future.' },
  { id: 7,  title: 'Courage to be Disliked', author: 'Ichiro Kishimi',    coverImage: '/book-covers/the-courage-to-be-disliked.webp',      spineColor: '#fefcfb', textColor: '#1a1a1a',                             rating: 5, overview: 'A liberating dialogue on Adlerian psychology. Learn to free yourself from the expectations of others and live authentically.' },
  { id: 8,  title: 'Tentacles',              author: 'Roland Smith',      coverImage: '/book-covers/tentacles.webp',                       spineColor: '#203e4f', textColor: '#38bdf8',                             rating: 3, overview: 'An adventure thriller following Marty and his mysterious uncle as they search for a giant squid in the deep ocean.' },
