    ...
    <section id="op-ed" style={{ borderBottom: '2px solid var(--fg)' }}>
      ...
      <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 1fr', columnGap: 0 }}>
        ...
        <div className="section-padding-x section-padding-y" style={{ borderRight: '1px solid rgba(14,14,12,0.2)' }}>
          ...
          <div style={{ fontFamily: '"Playfair Display", serif', fontSize: 'clamp(20px, 4vw, 22px)', fontWeight: 700, lineHeight: 1.2, color: 'var(--fg)' }}>
        ...
        <div className="section-padding-x section-padding-y" style={{ borderRight: '1px solid rgba(14,14,12,0.2)' }}>
          ...
          <blockquote style={{ margin: '0 0 24px', padding: 'clamp(16px, 3vw, 20px) clamp(18px, 3.5vw, 24px)', borderLeft: '4px solid var(--accent)', background: 'rgba(193,39,45,0.04)' }}>
            <p style={{ fontFamily: '"Playfair Display", serif', fontSize: 'clamp(16px, 3.5vw, 26px)', fontStyle: 'italic', fontWeight: 700, lineHeight: 1.3, color: 'var(--fg)', margin: 0 }}>
          ...
          <div style={{ marginTop: '20px', borderTop: '1px solid var(--fg)', paddingTop: '8px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px', fontFamily: '"JetBrains Mono", monospace', fontSize: 'clamp(9px, 2vw, 10px)', color: 'var(--sepia)' }}>
